        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">Record Playback</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 and Step5 require active runtime and do not support playback.</span>
            </div>
          </div>
        </div>
      </Transition>
...
// 导航到Knowledge Graph Construction页面（Project）
const goToProject = () => {
...
/* 不同功能的颜色 */
.status-icon:nth-child(1).available { color: #3B82F6; } /* Knowledge Graph Construction - 蓝色 */
