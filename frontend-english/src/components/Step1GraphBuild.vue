    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM分析文档内容与Simulation Requirement，提取出Reality Seed，自动生成合适的本体结构
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology，automatically chunk documents and call Zep 构建知识Graph，Extract entities and relations，并形成时序记忆与社区摘要
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph construction complete. Proceed to environment setup.</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? '创建中...' : 'Go to Env Setup ➝' }}
          </button>
        </div>
      </div>
    </div>
